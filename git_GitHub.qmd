...
<center>
![](images/git/your-repo.jpeg){width=450px}
</center>

If it's *your* repo--or you have write access to someone else's repo--follow the steps in the [next section](#st-pr-on-another-repo-with-branching), skipping steps 1 and 3. For emphasis, if you have write access, the repo will be "origin" not "upstream" from your perspective, and you will clone it directly, not fork it first.
...
<center>
![](images/git/pull-request-1.png){width=450px}
</center>
...
<center>
![](images/git/pull-request-2.png){width=450px}
</center>
...
- [Opening Issues](https://guides.github.com/features/issues/){target="_blank"}: On what Issues are in GitHub and how they can help get things done.
