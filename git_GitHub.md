...
### Random 
 ...
 - Make local the same as origin:<br>`git fetch origin`<br>`git reset --hard origin/master`   [SO link](https://stackoverflow.com/questions/1628088/reset-local-repository-branch-to-be-just-like-remote-repository-head){target="_blank"}
