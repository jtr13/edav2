...
2. Find all the x% quantile of a normal distribution that were observed in our sorted data. (Generally, we use normal data with 0 as median and 1 as standard deviation, also known as Z-distribution)
